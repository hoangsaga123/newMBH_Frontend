...
<b-navbar type="primary" variant="light" sticky>
    <div class="header-container px-3">
        ...
        <b-navbar-brand :to="{ name: 'Landing' }">
            ...
            <b-badge variant="warning" class="ml-3" v-if="userLoggedIn">JobSeeker</b-badge>
            <b-badge variant="secondary" class="ml-3" v-if="businessLoggedIn">Business</b-badge>
            <b-badge variant="success" class="ml-3" v-if="accommodationLoggedIn">Accommodation</b-badge>
        </b-navbar-brand>
        ...
        <b-navbar-nav id="publicNavbar" class="header-container" v-show="noLogin">
            ...
            <b-nav-item-dropdown id="signup-dropdown" class="signup-dropdown" text="Join Us" toggle-class="nav-link-custom" right>
        ...
        <b-navbar-nav id="userNavBar" class="header-container" v-show="businessLoggedIn">
            ...
            <b-nav-item to="/Seasonality">Seasonality</b-nav-item>
            <b-nav-item class="nav-item" to="/Search">Search</b-nav-item>
            <b-nav-item class="nav-item" to="/Advertisment">Advertisment</b-nav-item>

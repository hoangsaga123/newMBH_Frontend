        ...
        <div class="subscribe-options">
            <div class="subscribe-options-child">
                <div class="bg-white p-5 rounded-lg shadow">
                    ...
                    <button redirect-url="https://manybusyhands.au/#/Checkout" data-operation='create.token' v-show="canSubscribe" class="btn btn-primary btn-block p-2 shadow rounded-pill" data-sc-key="sbpb_YjAwODliNDAtMjI1Ni00MTNkLWI0YmUtMjE2ZDI1OWU4MWQ5" data-name="A Month Subscribe" data-description="Subscribe for 30 days" data-reference="99999" data-amount="3000" data-color="#0082cb">
                        Subscribe
                    </button>
                </div>
            </div>

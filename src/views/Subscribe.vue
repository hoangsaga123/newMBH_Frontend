        ...
        <div class="subscribe-options">
            <div class="subscribe-options-child">
                <div class="bg-white p-5 rounded-lg shadow">
                    ...
                    <button data-redirect-url="https://manybusyhands.au/#/Checkout" data-operation='create.token' v-show="canSubscribe" class="btn btn-primary btn-block p-2 shadow rounded-pill" data-sc-key="sbpb_YjAwODliNDAtMjI1Ni00MTNkLWI0YmUtMjE2ZDI1OWU4MWQ5" data-name="A Month Subscribe" data-description="Subscribe for 30 days" data-reference="99999" data-amount="3000" data-color="#0082cb">
                        Subscribe
                    </button>
                </div>
            </div>
            <div class="subscribe-options-child">
                <div class="bg-primary p-5 rounded-lg shadow">
                    ...
                    <button data-operation='create.token' v-show="canSubscribe" class="btn btn-primary btn-block p-2 shadow rounded-pill" data-sc-key="sbpb_YjAwODliNDAtMjI1Ni00MTNkLWI0YmUtMjE2ZDI1OWU4MWQ5" data-name="Quarter Year Subscribe" data-description="Subscribe for 90 days" data-reference="99999" data-amount="5000" data-color="#0082cb">
                        Subscribe
                    </button>
                </div>
            </div>
            ...
            <div class="subscribe-options-child">
                <div class="bg-white p-5 rounded-lg shadow">
                    ...
                    <button data-operation='create.token' v-show="canSubscribe" class="btn btn-primary btn-block p-2 shadow rounded-pill" data-sc-key="sbpb_YjAwODliNDAtMjI1Ni00MTNkLWI0YmUtMjE2ZDI1OWU4MWQ5" data-name="A Year Subscribe" data-description="Subscribe for 365 days" data-reference="99999" data-amount="12500" data-color="#0082cb">
                        Subscribe
                    </button>
                </div>
            </div>

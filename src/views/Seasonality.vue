...
<div class="seasonality-container">
    ...
    <b-container id="seasonality-search-area">
        ...
        <b-form>
            ...
            <b-row>
                <b-button size="lg" variant="success" class="mx-auto mt-3 mb-3" @click="searchSeasonality" :disabled="invalidSearchTerms">SEARCH</b-button>
            </b-row>
        </b-form>
    </b-container>
    ...
    <b-container v-show="showResults">
        ...
        <b-row>
            <b-pagination v-model="currentSeasonalityPage" class="mx-auto" :total-rows="seasonalityRows" :per-page="seasonalityItemsPerPage" first-text="First" prev-text="Prev" next-text="Next" last-text="Last" @change="loadData" aria-controls="seasonalityTable" />
        </b-row>
        <br>
    </b-container>
</div>

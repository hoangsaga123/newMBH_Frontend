                ...
                <b-col md="5" sm="auto" class="wow animated fadeInRight" data-wow-delay=".2s">
                    <div id="contact-form-area" class="pr-5 pt-4 mb-3">
                        <b-form id="contact-form" name="contact-form" class="text-white">
                            ...
                            <b-alert v-model="showDismissibleAlert" class="text-center pb-3 ml-4" label-align-sm="auto" variant="success" dismissible>
                                {{ successMessage }}
                            </b-alert>

                            <!-- CONTACT FORM SUBMIT BUTTON -->
                            <b-row>
                                <b-button variant="primary" class="mx-auto mb-4" id="contactSubmit" @click="submitContact">Send Message</b-button>
                            </b-row>
                        </b-form>
                    </div>
                </b-col>
    ...
    methods: {
        async submitContact() {
            if (this.validContactForm) {
                try {
                    await axios.post('https://3.25.51.142.nip.io/api/contactus', {
                    ...
                    console.log('Something wrong! Please send it again');
                }
            }
        },

        clearSuccessMessage() {
            // Clear the success message when the user dismisses it
            this.successMessage = '';
        },
    }
};
